"""In this version the program will display all the monster cards (in a list)
...
easygui.msgbox("sf", title="Results")
print("Results:")
print(f"Monster Name: {card_search}")
for values in monster_cards_catalogue[card_search]:
...
search_results = ""
if card_search:
    search_results = f"Results for {card_search}:\n"
    for attribute, value in monster_cards_catalogue[card_search].items():
        search_results += f"{attribute}: {value}\n"
