"""In this version the program will display all the monster cards (as buttons)
and the user can select the monster card they are searching for (Using easygui)
"""
...
card_search = easygui.buttonbox("Select the Monster Card you are searching for"
                                , title="Searching",
                                choices=catalogue)
